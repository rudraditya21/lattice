#ifndef LATTICE_CUDA_ABI_H
#define LATTICE_CUDA_ABI_H
...
#else
#define LATTICE_ABI_STATIC_ASSERT(cond, msg) \
...
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_elemwise_params_t) == 280,
                          lattice_elemwise_params_size);
LATTICE_ABI_STATIC_ASSERT(LATTICE_ABI_OFFSET(lattice_elemwise_params_t,
                                             count) == 0,
                          lattice_elemwise_params_count_off);
LATTICE_ABI_STATIC_ASSERT(LATTICE_ABI_OFFSET(lattice_elemwise_params_t, op) ==
                              8,
                          lattice_elemwise_params_op_off);
LATTICE_ABI_STATIC_ASSERT(LATTICE_ABI_OFFSET(lattice_elemwise_params_t,
                                             dtype) == 12,
                          lattice_elemwise_params_dtype_off);
LATTICE_ABI_STATIC_ASSERT(LATTICE_ABI_OFFSET(lattice_elemwise_params_t, ndim) ==
                              16,
...
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_fft_params_t) == 8,
                          lattice_fft_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_solve_params_t) == 16,
                          lattice_solve_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_lu_params_t) == 8,
                          lattice_lu_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_qr_params_t) == 16,
                          lattice_qr_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_svd_params_t) == 16,
                          lattice_svd_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_quantile_params_t) == 16,
                          lattice_quantile_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_correlation_params_t) == 8,
                          lattice_correlation_params_size);
LATTICE_ABI_STATIC_ASSERT(sizeof(lattice_regression_params_t) == 8,
                          lattice_regression_params_size);

#endif  // LATTICE_CUDA_ABI_H

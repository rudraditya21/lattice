...
- Portability: CPU SIMD-first, with planned GPU/accelerator backends (OpenCL with in-house kernels,
  not external BLAS/FFT); consistent behavior across platforms and builds.

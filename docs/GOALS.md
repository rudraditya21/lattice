...
- Portability: CPU SIMD-first, with GPU/accelerator backends (OpenCL/CUDA/HIP/Metal with in-house
  kernels, not external BLAS/FFT); consistent behavior across platforms and builds.

...
## Planned OpenCL Backend (Roadmap)
- OpenCL is the target GPU backend; kernels will be implemented in-house (no clBLAS/clFFT).
- Initial focus: dense elementwise ops, reductions, and matmul with explicit host/device transfers.

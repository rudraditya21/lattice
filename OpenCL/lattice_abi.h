...
#define LATTICE_ABI_OFFSET_ASSERT(name, type, field, expected) \
    LATTICE_ABI_STATIC_ASSERT(name,                            \
                              LATTICE_ABI_OFFSETOF(type, field) == (expected))
#else
#define LATTICE_ABI_OFFSET_ASSERT(name, type, field, expected)
#endif
...
LATTICE_ABI_STATIC_ASSERT(lattice_elemwise_params_size,
                          sizeof(lattice_elemwise_params_t) == 280);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_count_off,
                          lattice_elemwise_params_t,
                          count,
                          0);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_op_off,
                          lattice_elemwise_params_t,
                          op,
                          8);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_dtype_off,
                          lattice_elemwise_params_t,
                          dtype,
                          12);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_ndim_off,
                          lattice_elemwise_params_t,
                          ndim,
                          16);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_flags_off,
                          lattice_elemwise_params_t,
                          flags,
                          20);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_shape_off,
                          lattice_elemwise_params_t,
                          shape,
                          24);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_out_strides_off,
                          lattice_elemwise_params_t,
                          out_strides,
                          24 + 8 * LATTICE_MAX_TENSOR_DIMS);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_lhs_strides_off,
                          lattice_elemwise_params_t,
                          lhs_strides,
                          24 + 16 * LATTICE_MAX_TENSOR_DIMS);
LATTICE_ABI_OFFSET_ASSERT(lattice_elemwise_params_rhs_strides_off,
                          lattice_elemwise_params_t,
                          rhs_strides,
                          24 + 24 * LATTICE_MAX_TENSOR_DIMS);
LATTICE_ABI_STATIC_ASSERT(lattice_reduce_params_size,
                          sizeof(lattice_reduce_params_t) == 32);
LATTICE_ABI_OFFSET_ASSERT(lattice_reduce_params_count_off,
                          lattice_reduce_params_t,
                          count,
                          0);
LATTICE_ABI_OFFSET_ASSERT(lattice_reduce_params_op_off,
                          lattice_reduce_params_t,
                          op,
                          8);
LATTICE_ABI_OFFSET_ASSERT(lattice_reduce_params_dtype_off,
                          lattice_reduce_params_t,
                          dtype,
                          12);
LATTICE_ABI_OFFSET_ASSERT(lattice_reduce_params_flags_off,
                          lattice_reduce_params_t,
                          flags,
                          16);
LATTICE_ABI_OFFSET_ASSERT(lattice_reduce_params_stride_off,
                          lattice_reduce_params_t,
                          stride,
                          24);
...
LATTICE_ABI_STATIC_ASSERT(lattice_conv2d_params_size,
                          sizeof(lattice_conv2d_params_t) == 56);
LATTICE_ABI_STATIC_ASSERT(lattice_pool2d_params_size,
                          sizeof(lattice_pool2d_params_t) == 48);
LATTICE_ABI_STATIC_ASSERT(lattice_fft_params_size,
                          sizeof(lattice_fft_params_t) == 8);
LATTICE_ABI_STATIC_ASSERT(lattice_solve_params_size,
                          sizeof(lattice_solve_params_t) == 16);
LATTICE_ABI_STATIC_ASSERT(lattice_lu_params_size,
                          sizeof(lattice_lu_params_t) == 8);
LATTICE_ABI_STATIC_ASSERT(lattice_qr_params_size,
                          sizeof(lattice_qr_params_t) == 16);
LATTICE_ABI_STATIC_ASSERT(lattice_svd_params_size,
                          sizeof(lattice_svd_params_t) == 16);
LATTICE_ABI_STATIC_ASSERT(lattice_quantile_params_size,
                          sizeof(lattice_quantile_params_t) == 16);
LATTICE_ABI_STATIC_ASSERT(lattice_correlation_params_size,
                          sizeof(lattice_correlation_params_t) == 8);
LATTICE_ABI_STATIC_ASSERT(lattice_regression_params_size,
                          sizeof(lattice_regression_params_t) == 8);

#ifndef LATTICE_RUNTIME_BACKENDS_METAL_ABI_H_
#define LATTICE_RUNTIME_BACKENDS_METAL_ABI_H_

#include <cstddef>
#include <cstdint>

namespace lattice::runtime::metal {
...
static_assert(offsetof(ElemwiseParams, count) == 0,
              "ElemwiseParams.count offset mismatch");
static_assert(offsetof(ElemwiseParams, op) == 8,
              "ElemwiseParams.op offset mismatch");
static_assert(offsetof(ElemwiseParams, dtype) == 12,
              "ElemwiseParams.dtype offset mismatch");
static_assert(offsetof(ElemwiseParams, ndim) == 16,
              "ElemwiseParams.ndim offset mismatch");
static_assert(offsetof(ElemwiseParams, flags) == 20,
              "ElemwiseParams.flags offset mismatch");
static_assert(offsetof(ElemwiseParams, shape) == 24,
              "ElemwiseParams.shape offset mismatch");
...
static_assert(sizeof(CorrelationParams) == 8,
              "CorrelationParams size mismatch");
static_assert(sizeof(RegressionParams) == 8, "RegressionParams size mismatch");

}  // namespace lattice::runtime::metal

#endif  // LATTICE_RUNTIME_BACKENDS_METAL_ABI_H_

...
using OclBuildProgram = cl_int(CL_API_CALL*)(cl_program,
                                             cl_uint,
                                             const cl_device_id*,
                                             const char*,
                                             void(CL_CALLBACK*)(cl_program,
                                                                void*),
                                             void*);
using OclCreateBuffer =
    cl_mem(CL_API_CALL*)(cl_context, cl_mem_flags, size_t, void*, cl_int*);
using OclCreateCommandQueue =
    cl_command_queue(CL_API_CALL*)(cl_context,
                                   cl_device_id,
...
using OclCreateContext = cl_context(CL_API_CALL*)(
    ...
    void*,
    cl_int*);
using OclCreateKernel = cl_kernel(CL_API_CALL*)(cl_program,
                                                const char*,
                                                cl_int*);
using OclCreateProgramWithBinary =
    cl_program(CL_API_CALL*)(cl_context,
                             cl_uint,
                             const cl_device_id*,
                             const size_t*,
                             const unsigned char**,
                             cl_int*,
                             cl_int*);
using OclCreateProgramWithSource = cl_program(
    CL_API_CALL*)(cl_context, cl_uint, const char**, const size_t*, cl_int*);
using OclEnqueueCopyBuffer = cl_int(CL_API_CALL*)(cl_command_queue,
                                                  cl_mem,
                                                  cl_mem,
                                                  size_t,
                                                  size_t,
                                                  ...
                                                  const cl_event*,
                                                  cl_event*);
using OclEnqueueFillBuffer = cl_int(CL_API_CALL*)(cl_command_queue,
                                                  cl_mem,
                                                  const void*,
                                                  size_t,
                                                  size_t,
                                                  ...
                                                  const cl_event*,
                                                  cl_event*);
using OclEnqueueMapBuffer = void*(CL_API_CALL*)(cl_command_queue,
                                                cl_mem,
                                                cl_bool,
                                                cl_map_flags,
                                                size_t,
...
using OclEnqueueMarkerWithWaitList = cl_int(CL_API_CALL*)(cl_command_queue,
                                                          cl_uint,
                                                          const cl_event*,
                                                          cl_event*);
using OclEnqueueBarrier = cl_int(CL_API_CALL*)(cl_command_queue);
using OclEnqueueBarrierWithWaitList = cl_int(CL_API_CALL*)(cl_command_queue,
                                                           cl_uint,
                                                           const cl_event*,
                                                           cl_event*);
using OclEnqueueNDRangeKernel = cl_int(CL_API_CALL*)(cl_command_queue,
                                                     cl_kernel,
                                                     cl_uint,
                                                     const size_t*,
                                                     const size_t*,
                                                     ...
                                                     const cl_event*,
                                                     cl_event*);
using OclEnqueueReadBuffer = cl_int(CL_API_CALL*)(cl_command_queue,
                                                  cl_mem,
                                                  cl_bool,
                                                  size_t,
                                                  size_t,
                                                  ...
                                                  const cl_event*,
                                                  cl_event*);
using OclEnqueueUnmapMemObject = cl_int(CL_API_CALL*)(cl_command_queue,
                                                      cl_mem,
                                                      void*,
                                                      cl_uint,
                                                      const cl_event*,
                                                      cl_event*);
using OclEnqueueWriteBuffer = cl_int(CL_API_CALL*)(cl_command_queue,
                                                   cl_mem,
                                                   cl_bool,
                                                   size_t,
                                                   size_t,
...
using OclGetDeviceIDs = cl_int(CL_API_CALL*)(cl_platform_id,
                                             cl_device_type,
                                             cl_uint,
                                             cl_device_id*,
                                             cl_uint*);
using OclGetDeviceInfo =
    cl_int(CL_API_CALL*)(cl_device_id, cl_device_info, size_t, void*, size_t*);
using OclGetEventInfo =
    cl_int(CL_API_CALL*)(cl_event, cl_event_info, size_t, void*, size_t*);
using OclGetEventProfilingInfo =
    cl_int(CL_API_CALL*)(cl_event, cl_profiling_info, size_t, void*, size_t*);
using OclGetKernelWorkGroupInfo =
    cl_int(CL_API_CALL*)(cl_kernel,
                         cl_device_id,
                         cl_kernel_work_group_info,
                         size_t,
                         void*,
                         size_t*);
using OclGetPlatformIDs = cl_int(CL_API_CALL*)(cl_uint,
                                               cl_platform_id*,
                                               cl_uint*);
using OclGetPlatformInfo = cl_int(
    CL_API_CALL*)(cl_platform_id, cl_platform_info, size_t, void*, size_t*);
using OclGetProgramBuildInfo = cl_int(CL_API_CALL*)(cl_program,
                                                    cl_device_id,
                                                    cl_program_build_info,
                                                    size_t,
                                                    void*,
                                                    size_t*);
using OclGetProgramInfo =
    cl_int(CL_API_CALL*)(cl_program, cl_program_info, size_t, void*, size_t*);
using OclLinkProgram = cl_program(CL_API_CALL*)(cl_context,
                                                cl_uint,
                                                const cl_device_id*,
                                                const char*,
                                                cl_uint,
...
using OclSetKernelArg = cl_int(CL_API_CALL*)(cl_kernel,
                                             cl_uint,
                                             size_t,
                                             const void*);

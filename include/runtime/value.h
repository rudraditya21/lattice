...
struct Value {
    ...
    struct TensorInfo {
        ...
        double* Data() {
            return using_inline ? inline_storage.data() : storage.data();
        }
    ...
    static Value Tensor(std::vector<int64_t> shape,
                        DType elem_type,
                        double fill_value);
    static Value TensorSparseCSR(std::vector<int64_t> shape,
                                 std::vector<int64_t> indptr,
                                 std::vector<int64_t> indices,
                                 std::vector<double> values,
                                 DType elem_type);
    static Value TensorSparseCOO(std::vector<int64_t> shape,
                                 std::vector<int64_t> rows,
                                 std::vector<int64_t> cols,
                                 std::vector<double> values,
                                 DType elem_type);
    static Value TensorRagged(std::vector<int64_t> row_splits,
                              std::vector<double> values,
                              DType elem_type);
...
inline Value Value::RationalValue(int64_t num, int64_t den) {
    ...
    val.f64 =
        static_cast<double>(num) / static_cast<double>(den == 0 ? 1 : den);
    val.number = val.f64;
...
inline Value Value::Tensor(std::vector<int64_t> shape,
                           DType elem_type,
                           double fill_value) {
    Value val;
...
inline Value Value::TensorSparseCSR(std::vector<int64_t> shape,
                                    std::vector<int64_t> indptr,
                                    std::vector<int64_t> indices,
                                    std::vector<double> values,
                                    DType elem_type) {
...
inline Value Value::TensorSparseCOO(std::vector<int64_t> shape,
                                    std::vector<int64_t> rows,
                                    std::vector<int64_t> cols,
                                    std::vector<double> values,
                                    DType elem_type) {
...
inline Value Value::TensorRagged(std::vector<int64_t> row_splits,
                                 std::vector<double> values,
                                 DType elem_type) {
    Value val;
    val.type = DType::kTensor;

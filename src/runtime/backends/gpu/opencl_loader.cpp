...
bool OpenCLLoader::Load(std::string* error) {
    ...
    ok &= LoadSymbol(lib, "clCreateProgramWithBinary",
                     &clCreateProgramWithBinary, error);
    ok &= LoadSymbol(lib, "clCreateProgramWithSource",
    ...
    LoadSymbol(lib, "clEnqueueMarkerWithWaitList", &clEnqueueMarkerWithWaitList,
               nullptr);
    LoadSymbol(lib, "clEnqueueBarrierWithWaitList",
               &clEnqueueBarrierWithWaitList, nullptr);
    LoadSymbol(lib, "clEnqueueMarker", &clEnqueueMarker, nullptr);
    LoadSymbol(lib, "clEnqueueBarrier", &clEnqueueBarrier, nullptr);
    ok &= LoadSymbol(lib, "clEnqueueNDRangeKernel", &clEnqueueNDRangeKernel,
                     error);
    ok &= LoadSymbol(lib, "clEnqueueReadBuffer", &clEnqueueReadBuffer, error);
    LoadSymbol(lib, "clEnqueueUnmapMemObject", &clEnqueueUnmapMemObject,
               nullptr);
    ...
    ok &= LoadSymbol(lib, "clGetEventProfilingInfo", &clGetEventProfilingInfo,
                     error);
    ok &= LoadSymbol(lib, "clGetKernelWorkGroupInfo", &clGetKernelWorkGroupInfo,
                     error);
    ok &= LoadSymbol(lib, "clGetPlatformIDs", &clGetPlatformIDs, error);
    ok &= LoadSymbol(lib, "clGetPlatformInfo", &clGetPlatformInfo, error);
    ok &=
        LoadSymbol(lib, "clGetProgramBuildInfo", &clGetProgramBuildInfo, error);
    ok &= LoadSymbol(lib, "clGetProgramInfo", &clGetProgramInfo, error);
    ok &= LoadSymbol(lib, "clLinkProgram", &clLinkProgram, error);
    ok &=
        LoadSymbol(lib, "clReleaseCommandQueue", &clReleaseCommandQueue, error);

...
bool HipLoader::Load(std::string* error) {
    ...
    LoadOptional(driver, "hipEventCreateWithFlags", &hipEventCreateWithFlags);
    ...
    LoadOptional(driver, "hipEventElapsedTime", &hipEventElapsedTime);
    ...
    if (LoadHiprtcLib(&hiprtc)) {
        LoadSymbol(hiprtc, "hiprtcCreateProgram", &hiprtcCreateProgram,
                   nullptr);
        LoadSymbol(hiprtc, "hiprtcCompileProgram", &hiprtcCompileProgram,
                   nullptr);
        LoadSymbol(hiprtc, "hiprtcDestroyProgram", &hiprtcDestroyProgram,
                   nullptr);
        LoadSymbol(hiprtc, "hiprtcGetCodeSize", &hiprtcGetCodeSize, nullptr);
        LoadSymbol(hiprtc, "hiprtcGetCode", &hiprtcGetCode, nullptr);
        LoadSymbol(hiprtc, "hiprtcGetProgramLogSize", &hiprtcGetProgramLogSize,
                   nullptr);
        LoadSymbol(hiprtc, "hiprtcGetProgramLog", &hiprtcGetProgramLog,
                   nullptr);
        LoadSymbol(hiprtc, "hiprtcGetErrorString", &hiprtcGetErrorString,
                   nullptr);
    }

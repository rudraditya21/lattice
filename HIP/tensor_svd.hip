...
extern "C" __global__ void lattice_svd(const scalar_t* a,
                                       scalar_t* u,
                                       scalar_t* s,
                                       scalar_t* v,
    ...
    if (disc < static_cast<scalar_t>(0))
        disc = static_cast<scalar_t>(0);
    ...
    if (lattice_abs(ata01) < static_cast<scalar_t>(1e-6)) {
        ...
        scalar_t sign = t >= static_cast<scalar_t>(0)
                            ? static_cast<scalar_t>(1)
                            : static_cast<scalar_t>(-1);
        scalar_t tau = sign / (lattice_abs(t) +
                               lattice_sqrt(static_cast<scalar_t>(1) + t * t));
        scalar_t cs = static_cast<scalar_t>(1) /
                      lattice_sqrt(static_cast<scalar_t>(1) + tau * tau);
        scalar_t sn = cs * tau;
        v[0] = cs;
        v[1] = -sn;
        v[2] = sn;
